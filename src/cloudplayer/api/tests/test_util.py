...
def test_chunk_range_should_range_and_split_numbers():
    assert chunk_range(0, 0, 0) == [(0, None)]
    assert chunk_range(3, 0, 0) == [(0, None)]
    assert chunk_range(3, 0, 1) == [(0, None)]
    assert chunk_range(3, 0, 2) == [(0, 2), (2, None)]
    assert chunk_range(3, 3, 2) == [(0, None)]
    assert chunk_range(3, 0, 3) == [(0, 1), (1, 2), (2, None)]
    assert chunk_range(3, 2, 3) == [(0, 2), (2, None)]
    assert chunk_range(3, 0, 4) == [(0, 1), (1, 2), (2, None)]
